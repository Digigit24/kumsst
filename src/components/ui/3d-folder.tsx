...
interface AnimatedFolderProps {
  ...
  className?: string
  onFolderClick?: () => void
  onItemClick?: (item: FolderItem, index: number) => void
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle at 50% 70%, hsl(var(--folder-front)) 0%, transparent 70%)",
        ...
        <div className="relative flex items-center justify-center mb-4" style={{ height: "160px", width: "200px" }}>
          ...
          {/* Item cards - z-index 20, between back and front */}
          <div
            className="absolute"
            style={{
              top: "50%",
...
function ImageLightbox({
  ...
  const hasNext = internalIndex < totalItems - 1
  ...
  const navigateNext = useCallback(() => {
    if (internalIndex >= totalItems - 1 || isSliding) return
    onNavigate(internalIndex + 1)
  }, [internalIndex, totalItems, isSliding, onNavigate])
...
const FolderItemCard = forwardRef<HTMLDivElement, FolderItemCardProps>(
...
FolderItemCard.displayName = "FolderItemCard"

export { FolderItemCard, ImageLightbox }
export type { FolderItem, AnimatedFolderProps }
