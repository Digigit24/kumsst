/**
 * Construction Material Requests Page
 * CRUD for material requests with Draft/Submit/Approve/Reject flow.
 */
...
import { invalidateMaterialRequests, useMaterialRequestsSWR, useProjectsSWR } from '../../hooks/useConstructionSWR';
import type {
    MaterialRequest,
...
export function MaterialRequestsPage() {
    ...
    const resetForm = () => {
        ...
        setPriority('medium');
        setJustification('');
        setItems([{ item_name: '', quantity: '', unit: '', description: '', estimated_cost: '' }]);
    };

    // Item Management
    const addItemRow = () => {
        setItems([...items, { item_name: '', quantity: '', unit: '', description: '', estimated_cost: '' }]);
    };
    ...
    const handleSaveForm = async () => {
        ...
        const payload: MaterialRequestCreateInput = {
            ...
            items: filteredItems.map(item => ({
                id: item.id, // Important if updating existing items (usually backend dependent, but adding for completeness)
        ...
        <div className="p-4 md:p-6 flex flex-col gap-6">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-bold">Material Requests</h1>
                        <p className="text-xs text-muted-foreground">Draft and approve material indents from sites</p>
                    </div>
                </div>
            ...
            <DetailSidebar
                ...
                subtitle={
                    sidebarMode === 'view' ? `Request ID #${selectedRequest?.id}` : 'Fill in the indent details'
                }
                width="3xl"
                mode={sidebarMode}
                footer={
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-b pb-6">
                        <div className="space-y-2">
                            <Label>Project *</Label>
                            <Select value={project} onValueChange={setProject} disabled={isViewMode}>
