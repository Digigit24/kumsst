 ...
 * CRUD + CEO Verification for construction milestones using DetailSidebar.
 */
...
import { invalidateMilestones, useMilestonesSWR, useProjectsSWR } from '../../hooks/useConstructionSWR';
import type { Milestone, MilestoneCreateInput, MilestoneStatus, MilestoneUpdateInput } from '../../types/construction.types';
...
export function MilestonesPage() {
    ...
    const { results: projects } = useProjectsSWR({ page_size: 100 });
    ...
    const columns: Column<Milestone>[] = [
        ...
        },
        {
            key: 'project_name',
            label: 'Project',
            render: (row) => <span className="text-sm font-medium">{row.project_name || `Project #${row.project}`}</span>,
        },
        {
            key: 'status',
            label: 'Status',
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">Track project milestones and verify completions</p>
                    </div>
                </div>
                {canManage && (
