 ...
 * Grid/List view of site photos with verification workflow for Construction Heads/CEOs.
 */
...
import { invalidatePhotos, usePhotosSWR, useProjectsSWR } from '../../hooks/useConstructionSWR';
import type { ConstructionPhoto, PhotoType } from '../../types/construction.types';
...
export function ConstructionPhotosPage() {
    const { user } = useAuth();
    ...
    const handleUploadClick = () => {
        ...
        setUploadFile(null);
        setFormData({ project: '', photo_type: 'progress', caption: '' });
    ...
    return (
        <div className="p-4 md:p-6 flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">Upload and manage construction site photos</p>
                    </div>
                </div>
            ...
            <DetailSidebar
                ...
                subtitle={sidebarMode === 'create' ? 'Add a new image' : `ID #${selectedPhoto?.id}`}
                width="2xl"
                mode={sidebarMode}
                footer={
                    sidebarMode === 'create' ? (
