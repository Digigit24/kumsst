...
import { invalidateExpenses, useExpensesSWR } from '../../../hooks/useConstructionSWR';
import type {
    ConstructionExpense,
...
export function ProjectExpensesTab({ project }: { project: ConstructionProject }) {
    const { user } = useAuth();
    ...
    const [filters, setFilters] = useState<Record<string, any>>({
        page: 1,
        page_size: 10,
        project: project.id // Scoped specifically to this project
    });
    ...
    const [formData, setFormData] = useState<ExpenseFormData>({ ...defaultFormData, project: String(project.id) });
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-lg font-bold">Construction Expenses</h2>
                        <p className="text-sm text-muted-foreground">Record site expenses, upload receipts, and manage approvals</p>
                    </div>
                </div>
            ...
            <DetailSidebar
                ...
                subtitle={
                    sidebarMode === 'view'
                        ? `Expense ID #${selectedExpense?.id} — ${project.project_name}`
                        : `Provide accurate billing details for ${project.project_name}`
                }
                width="2xl"
                mode={sidebarMode}
                footer={
